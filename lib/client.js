window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const tagId$2 = "@dsh-external/yet-another-subagent/SubagentCard.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@dsh-external/yet-another-subagent";
		...
		*/
		...
		const tagId$1 = "@dsh-external/yet-another-subagent/SubagentTreeView.module.css";
		...
		*/
		function SubagentTreeView({ sessionId, sessions, profileLabelOf, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChildList, {
					parentId: rootId,
		...
		function ChildList({ parentId, currentSessionId, sessions, profileLabelOf, t, depth }) {
			const children = useChildren(sessions, parentId);
			const childIds = Object.keys(children);
			if (depth === 0 && childIds.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				style: { "--depth": depth },
				children: childIds.map((childId) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChildNode, {
					childId,
		...
		function ChildNode({ childId, profileId, currentSessionId, sessions, profileLabelOf, t, depth }) {
			...
			const openChild = () => {
				...
				for (const mode of ["continuable", "one-shot"]) try {
					sessions.openSubagent({
						parentSessionId: sessions.subagentAddress?.(childId)?.parentSessionId ?? currentSessionId,
						childSessionId: childId,
						mode
					});
					return;
		...
		const tagId = "@dsh-external/yet-another-subagent/SettingsPage.module.css";
		...
		*/
		...
		async function callRpc(rpc, endpoint, payload) {
			return rpc.call("/api", endpoint, payload);
		}
		/**
		...
		*/
		function apply(ctx) {
			...
			const fetchProfilesInternal = async () => {
				const result = await connection.rpc.call("/api", "ya-subagent/profiles.list", {});
